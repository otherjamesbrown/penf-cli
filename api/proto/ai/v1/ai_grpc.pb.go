...
const (
	...
	AICoordinatorService_GetStageConfig_FullMethodName      = "/penfold.ai.v1.AICoordinatorService/GetStageConfig"
	AICoordinatorService_SetStageConfig_FullMethodName      = "/penfold.ai.v1.AICoordinatorService/SetStageConfig"
	AICoordinatorService_ResetStageConfig_FullMethodName    = "/penfold.ai.v1.AICoordinatorService/ResetStageConfig"
	AICoordinatorService_ListAvailableModels_FullMethodName = "/penfold.ai.v1.AICoordinatorService/ListAvailableModels"
	AICoordinatorService_TestStage_FullMethodName           = "/penfold.ai.v1.AICoordinatorService/TestStage"
...
type AICoordinatorServiceClient interface {
	...
	// Shows which model each stage uses and the config source (db override, env var, default).
	GetStageConfig(ctx context.Context, in *GetStageConfigRequest, opts ...grpc.CallOption) (*GetStageConfigResponse, error)
	// SetStageConfig sets the model for a specific pipeline stage or default.
	// Creates a DB override that takes precedence over env vars.
	SetStageConfig(ctx context.Context, in *SetStageConfigRequest, opts ...grpc.CallOption) (*SetStageConfigResponse, error)
	// ResetStageConfig removes the DB override for a stage, reverting to env var or default.
	ResetStageConfig(ctx context.Context, in *ResetStageConfigRequest, opts ...grpc.CallOption) (*ResetStageConfigResponse, error)
	...
	// TestStage runs a quick inference test for a pipeline stage using its configured model.
	TestStage(ctx context.Context, in *TestStageRequest, opts ...grpc.CallOption) (*TestStageResponse, error)
...
func (c *aICoordinatorServiceClient) GetStageConfig(ctx context.Context, in *GetStageConfigRequest, opts ...grpc.CallOption) (*GetStageConfigResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetStageConfigResponse)
	err := c.cc.Invoke(ctx, AICoordinatorService_GetStageConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aICoordinatorServiceClient) SetStageConfig(ctx context.Context, in *SetStageConfigRequest, opts ...grpc.CallOption) (*SetStageConfigResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetStageConfigResponse)
	err := c.cc.Invoke(ctx, AICoordinatorService_SetStageConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aICoordinatorServiceClient) ResetStageConfig(ctx context.Context, in *ResetStageConfigRequest, opts ...grpc.CallOption) (*ResetStageConfigResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ResetStageConfigResponse)
	err := c.cc.Invoke(ctx, AICoordinatorService_ResetStageConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aICoordinatorServiceClient) ListAvailableModels(ctx context.Context, in *ListAvailableModelsRequest, opts ...grpc.CallOption) (*ListAvailableModelsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListAvailableModelsResponse)
	err := c.cc.Invoke(ctx, AICoordinatorService_ListAvailableModels_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aICoordinatorServiceClient) TestStage(ctx context.Context, in *TestStageRequest, opts ...grpc.CallOption) (*TestStageResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TestStageResponse)
	err := c.cc.Invoke(ctx, AICoordinatorService_TestStage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AICoordinatorServiceServer interface {
	...
	// SetStageConfig sets the model for a specific pipeline stage or default.
	// Creates a DB override that takes precedence over env vars.
	SetStageConfig(context.Context, *SetStageConfigRequest) (*SetStageConfigResponse, error)
	// ResetStageConfig removes the DB override for a stage, reverting to env var or default.
	ResetStageConfig(context.Context, *ResetStageConfigRequest) (*ResetStageConfigResponse, error)
	// ListAvailableModels returns models installed on Ollama plus known remote models.
	ListAvailableModels(context.Context, *ListAvailableModelsRequest) (*ListAvailableModelsResponse, error)
	// TestStage runs a quick inference test for a pipeline stage using its configured model.
	TestStage(context.Context, *TestStageRequest) (*TestStageResponse, error)
	// Query performs RAG-style question answering over the knowledge base.
	// Searches relevant content and generates an answer using an LLM.
...
func (UnimplementedAICoordinatorServiceServer) ExtractAssertions(context.Context, *AssertionRequest) (*AssertionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ExtractAssertions not implemented")
}
func (UnimplementedAICoordinatorServiceServer) ClassifyContent(context.Context, *ClassifyContentRequest) (*ClassifyContentResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ClassifyContent not implemented")
}
func (UnimplementedAICoordinatorServiceServer) TriageContent(context.Context, *TriageContentRequest) (*TriageContentResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method TriageContent not implemented")
}
...
func (UnimplementedAICoordinatorServiceServer) DeepAnalyze(context.Context, *DeepAnalyzeRequest) (*DeepAnalyzeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeepAnalyze not implemented")
}
...
func (UnimplementedAICoordinatorServiceServer) GetStageConfig(context.Context, *GetStageConfigRequest) (*GetStageConfigResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetStageConfig not implemented")
}
func (UnimplementedAICoordinatorServiceServer) SetStageConfig(context.Context, *SetStageConfigRequest) (*SetStageConfigResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetStageConfig not implemented")
}
func (UnimplementedAICoordinatorServiceServer) ResetStageConfig(context.Context, *ResetStageConfigRequest) (*ResetStageConfigResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ResetStageConfig not implemented")
}
func (UnimplementedAICoordinatorServiceServer) ListAvailableModels(context.Context, *ListAvailableModelsRequest) (*ListAvailableModelsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListAvailableModels not implemented")
}
func (UnimplementedAICoordinatorServiceServer) TestStage(context.Context, *TestStageRequest) (*TestStageResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method TestStage not implemented")
}
...
func (UnimplementedAICoordinatorServiceServer) SummarizeByID(context.Context, *SummarizeByIDRequest) (*SummarizeByIDResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SummarizeByID not implemented")
}
func (UnimplementedAICoordinatorServiceServer) AnalyzeByID(context.Context, *AnalyzeByIDRequest) (*AnalyzeByIDResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AnalyzeByID not implemented")
}
...
func RegisterAICoordinatorServiceServer(s grpc.ServiceRegistrar, srv AICoordinatorServiceServer) {
	// If the following call panics, it indicates UnimplementedAICoordinatorServiceServer was
...
func _AICoordinatorService_GetStageConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetStageConfigRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AICoordinatorServiceServer).GetStageConfig(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AICoordinatorService_GetStageConfig_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AICoordinatorServiceServer).GetStageConfig(ctx, req.(*GetStageConfigRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AICoordinatorService_SetStageConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetStageConfigRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AICoordinatorServiceServer).SetStageConfig(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AICoordinatorService_SetStageConfig_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AICoordinatorServiceServer).SetStageConfig(ctx, req.(*SetStageConfigRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AICoordinatorService_ResetStageConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ResetStageConfigRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AICoordinatorServiceServer).ResetStageConfig(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AICoordinatorService_ResetStageConfig_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AICoordinatorServiceServer).ResetStageConfig(ctx, req.(*ResetStageConfigRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AICoordinatorService_ListAvailableModels_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListAvailableModelsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AICoordinatorServiceServer).ListAvailableModels(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AICoordinatorService_ListAvailableModels_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AICoordinatorServiceServer).ListAvailableModels(ctx, req.(*ListAvailableModelsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AICoordinatorService_TestStage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TestStageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AICoordinatorServiceServer).TestStage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AICoordinatorService_TestStage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AICoordinatorServiceServer).TestStage(ctx, req.(*TestStageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AICoordinatorService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AICoordinatorService_GetStageConfig_Handler,
		},
		{
			MethodName: "SetStageConfig",
			Handler:    _AICoordinatorService_SetStageConfig_Handler,
		},
		{
			MethodName: "ResetStageConfig",
			Handler:    _AICoordinatorService_ResetStageConfig_Handler,
		},
		{
			MethodName: "ListAvailableModels",
			Handler:    _AICoordinatorService_ListAvailableModels_Handler,
		},
		{
			MethodName: "TestStage",
			Handler:    _AICoordinatorService_TestStage_Handler,
		},
		{
			MethodName: "Query",
