...
func (UnimplementedAICoordinatorServiceServer) SetStageConfig(context.Context, *SetStageConfigRequest) (*SetStageConfigResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetStageConfig not implemented")
}
func (UnimplementedAICoordinatorServiceServer) ResetStageConfig(context.Context, *ResetStageConfigRequest) (*ResetStageConfigResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ResetStageConfig not implemented")
}
...
func (UnimplementedAICoordinatorServiceServer) TestStage(context.Context, *TestStageRequest) (*TestStageResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TestStage not implemented")
}
